...
<div id="rectmenu">
	...
	<form:form method ="POST" action = "/SpringCrudExample/login" id="signup-form">    
  ...
  <h1 class="heading heading-correct-pronounciation">
	...
	<p>Already registered? Then <button class="btn btn-default" type="submit">Sign In</button> here</p> 
<%--   </form>
 --%>
 </form:form>
 </div>
